...
/* COBALT LOCAL: command line is last 512 bytes of physical memory 
	Note that CL_SIZE only sizes saved_command_line; it does not
	affect the location of the commandline as passed from the rom/ramcode
	(see kRealkernelCommandline in include/diagdefs.h for that) */
