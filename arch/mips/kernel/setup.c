 ...
 *
 * $Id: setup.c,v 1.5 1998/12/11 10:22:39 gid Exp $
 */
...
/* COBALT LOCAL - need to be able to assign command_line */

/* static char command_line[] = "root=/dev/hda1 ro"; */
static char * command_line = "root=/dev/hda1 ro";	
                ...
                unsigned long * memory_end_p)
{
	...
	/* COBALT LOCAL stuff here   - gid */
	
	/*
	 * important - 
	 *
	 * kBootloaderCommandline should be == (mips_memory_upper - 512)
	 */

#ifdef BOOTLOADER

#include "../../../../include/diagdefs.h"
	command_line = kBootloaderCommandline;
#else
	command_line = (char *) (mips_memory_upper - 512); 
#endif

	/* END cobalt local stuff */
